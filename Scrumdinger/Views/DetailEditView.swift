...
struct DetailEditView: View {
    ...
    @State private var errorWarpper: ErrorWrapper?
            ...
            ToolbarItem(placement: .confirmationAction) {
                Button("Done") {
                    do {
                        ...
                        errorWarpper = ErrorWrapper(error: error, guidance: "Daily scrum was not recorded. Try again later.")
                    }
                }
            }
        }
        .sheet(item: $errorWarpper) {
            dismiss()
        } content: { wrapper in
